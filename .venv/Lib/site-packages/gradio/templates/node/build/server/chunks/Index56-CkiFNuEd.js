...
import { B as Block, S as Static, g as BlockLabel, z as File$1, i as Empty, U as UploadText, j as IconButtonWrapper, k as IconButton, K as Undo, n as Download } from './2-4RLkcd-H.js';
import { U as Upload, M as ModifyUpload } from './ModifyUpload-Dz3WxHfK.js';
...
async function loadCanvas3D$1() {
  const module = await import('./Canvas3D-Coja_qQt.js');
  return module.default;
}
async function loadCanvas3DGS$1() {
  const module = await import('./Canvas3DGS-CbG7ivy2.js');
  return module.default;
}
...
//# sourceMappingURL=Index56-CkiFNuEd.js.map
