...
import { B as Block, S as Static, g as BlockLabel, V as Code$2, i as Empty, k as IconButton, A as Copy$1, D as DownloadLink, n as Download$1, j as IconButtonWrapper, W as getWorkerProxyContext } from './2-4RLkcd-H.js';
...
const lang_map = {
  python: () => import('./index33-DJ1ExeIT.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index34-o4EOGVbZ.js'),
      import('./frontmatter-BHh05yoO.js')
    ]);
  ...
  json: () => import('./index38-H8U24v9S.js').then((m) => m.json()),
  html: () => import('./index35-DHlsSVGC.js').then((m) => m.html()),
  css: () => import('./index36-AOJD17je.js').then((m) => m.css()),
  javascript: () => import('./index37-BufyT2b0.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index37-BufyT2b0.js').then(
...
//# sourceMappingURL=Index16-2ykszUy6.js.map
